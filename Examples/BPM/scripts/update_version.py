...
def main():
  ...
  plistpath = scriptpath + "/resources/BPM-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BPM-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BPM-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BPM-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BPM-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BPM.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BPM.iss",inplace=1):
