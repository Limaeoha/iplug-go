...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=BPM Demo Installer\n"
      else:
        line="OutputBaseFilename=BPM Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the BPM Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the BPM installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=BPM Demo installer\n"
     else:
       line="SetupWindowTitle=BPM installer\n"
