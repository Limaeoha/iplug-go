...
//  printf("ok\n");
  return popen2("/Users/ianlozinski/code/iPlug2/Examples/BPM/echo/echo", dir);
}



BPM::BPM(const InstanceInfo& info)
...
#if IPLUG_DSP
void BPM::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
  // build message
  packet.Clear();
