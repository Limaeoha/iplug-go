...
def main():
  ...
  plistpath = scriptpath + "/resources/Delay2-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delay2-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delay2-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delay2-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Delay2-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Delay2.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Delay2.iss",inplace=1):
