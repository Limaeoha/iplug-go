...
def main():
  ...
  plistpath = scriptpath + "/resources/Stethoscope-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Stethoscope-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Stethoscope-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Stethoscope-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Stethoscope-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Stethoscope.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Stethoscope.iss",inplace=1):
