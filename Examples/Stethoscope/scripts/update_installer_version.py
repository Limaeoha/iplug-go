...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Stethoscope Demo Installer\n"
      else:
        line="OutputBaseFilename=Stethoscope Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Stethoscope Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Stethoscope installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Stethoscope Demo installer\n"
     else:
       line="SetupWindowTitle=Stethoscope installer\n"
